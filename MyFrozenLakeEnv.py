...
def generate_random_map(size=8, p=0.8):
    """
    We won't need this for NONMEM search
...
class FrozenLakeEnv(discrete.DiscreteEnv):
    ...
    def step(self, a):
        """ will need to edit for step in given
        dimension
        """
    ...
    def reset(self):
        """
        local reset, will need to be editted
        """
        self.s = self.categorical_sample(self.isd, self.np_random)
        ## this seems to always return 0 - reset to starting position
